...
namespace PressHmi.ViewModel
{
    public class ParaSubDiePartingPageViewModel : ViewModelBase
    {
        ...
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_SectionNum, _fanuc.CurLimitBom.DPP_SectionNum, "输入开模曲线段数");
            dlg.ShowDialog();
        }

        private void OnPreDelayTimeSet()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_PreDelayTime, _fanuc.CurLimitBom.DPP_PreDelayTime, "输入开模前延时(s)");
            dlg.ShowDialog();

        }
        private void OnSafeTimeSet()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_SafeTime, _fanuc.CurLimitBom.DPP_SafeTime, "输入开模安全时间(s)");
            dlg.ShowDialog();
        }
        ...
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_1, _fanuc.CurLimitBom.DPP_Pos_1, "输入P1位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_2Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_2, _fanuc.CurLimitBom.DPP_Pos_2, "输入P2位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_3Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_3, _fanuc.CurLimitBom.DPP_Pos_3, "输入P3位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_4Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_4, _fanuc.CurLimitBom.DPP_Pos_4, "输入P4位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_5Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_5, _fanuc.CurLimitBom.DPP_Pos_5, "输入P5位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_6Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_6, _fanuc.CurLimitBom.DPP_Pos_6, "输入P6位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_7Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_7, _fanuc.CurLimitBom.DPP_Pos_7, "输入P7位置(mm)");
            dlg.ShowDialog();
        }

        private void OnPos_8Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Pos_8, _fanuc.CurLimitBom.DPP_Pos_8, "输入P8位置(mm)");
            dlg.ShowDialog();
        }

        private void OnSpeed_1Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_1, _fanuc.CurLimitBom.DPP_Speed_1, "输入P1速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_2Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_2, _fanuc.CurLimitBom.DPP_Speed_2, "输入P2速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_3Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_3, _fanuc.CurLimitBom.DPP_Speed_3, "输入P3速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_4Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_4, _fanuc.CurLimitBom.DPP_Speed_4, "输入P4速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_5Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_5, _fanuc.CurLimitBom.DPP_Speed_5, "输入P5速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_6Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_6, _fanuc.CurLimitBom.DPP_Speed_6, "输入P6速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_7Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_7, _fanuc.CurLimitBom.DPP_Speed_7, "输入P7速度(%)");
            dlg.ShowDialog();
        }

        private void OnSpeed_8Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_Speed_8, _fanuc.CurLimitBom.DPP_Speed_8, "输入P8速度(%)");
            dlg.ShowDialog();
        }

        private void OnStopTime_1Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_1, _fanuc.CurLimitBom.DPP_StopTime_1, "输入P1停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_2Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_2, _fanuc.CurLimitBom.DPP_StopTime_2, "输入P2停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_3Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_3, _fanuc.CurLimitBom.DPP_StopTime_3, "输入P3停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_4Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_4, _fanuc.CurLimitBom.DPP_StopTime_4, "输入P4停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_5Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_5, _fanuc.CurLimitBom.DPP_StopTime_5, "输入P5停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_6Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_6, _fanuc.CurLimitBom.DPP_StopTime_6, "输入P6停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_7Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_7, _fanuc.CurLimitBom.DPP_StopTime_7, "输入P7停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnStopTime_8Set()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_StopTime_8, _fanuc.CurLimitBom.DPP_StopTime_8, "输入P8停止时间(s)");
            dlg.ShowDialog();
        }

        private void OnBottomDeadCentreSet()
        {
            var dlg = new MacroDataInputDialog(_fanuc, _fanuc.CurMacroBom.DPP_BottomDeadCentre, _fanuc.CurLimitBom.DPP_BottomDeadCentre, "输入下死点位置(mm)");
            dlg.ShowDialog();
        }
