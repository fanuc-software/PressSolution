...
{
    public class ParaAutoAirSourceInfoDto : ViewModelBase
    {
        ...
        private double m_StartPos_3;
        public double StartPos_3
        {
            get { return m_StartPos_3; }
            set
            {
                if (m_StartPos_3 != value)
                {
                    m_StartPos_3 = value;
                    RaisePropertyChanged(() => StartPos_3);
                }
            }
        }

        public string StrStartPos_3
        {
            get
            {
                return StartPos_3.ToString("0.00");
            }
        }
        ...
        public double StartArr_3
        {
            ...
            set
            {
                if (m_StartArr_3 != value)
                {
                    m_StartArr_3 = value;
                    RaisePropertyChanged(() => StartArr_3);
                }
            }
        }

        private double m_EndPos_3;
        public double EndPos_3
        {
            get { return m_EndPos_3; }
            set
            {
                if (m_EndPos_3 != value)
                {
                    m_EndPos_3 = value;
                    RaisePropertyChanged(() => EndPos_3);
                }
            }
        }

        public string StrEndPos_3
        {
            get
            {
                return EndPos_3.ToString("0.00");
            }
        }
        ...
        public double ActionFlag_3
        {
            ...
            set
            {
                if (m_ActionFlag_3 != value)
                {
                    m_ActionFlag_3 = value;
                    RaisePropertyChanged(() => ActionFlag_3);
                }
            }
        }

        private double m_StartPos_4;
        public double StartPos_4
        {
            get { return m_StartPos_4; }
            set
            {
                if (m_StartPos_4 != value)
                {
                    m_StartPos_4 = value;
                    RaisePropertyChanged(() => StartPos_4);
                }
            }
        }

        public string StrStartPos_4
        {
            get
            {
                return StartPos_4.ToString("0.00");
            }
        }
        ...
        public double StartArr_4
        {
            ...
            set
            {
                if (m_StartArr_4 != value)
                {
                    m_StartArr_4 = value;
                    RaisePropertyChanged(() => StartArr_4);
                }
            }
        }

        private double m_EndPos_4;
        public double EndPos_4
        {
            get { return m_EndPos_4; }
            set
            {
                if (m_EndPos_4 != value)
                {
                    m_EndPos_4 = value;
                    RaisePropertyChanged(() => EndPos_4);
                }
            }
        }

        public string StrEndPos_4
        {
            get
            {
                return EndPos_4.ToString("0.00");
            }
        }
        ...
        public double ActionFlag_4
        {
            ...
            set
            {
                if (m_ActionFlag_4 != value)
                {
                    m_ActionFlag_4 = value;
                    RaisePropertyChanged(() => ActionFlag_4);
                }
            }
        }
    }
